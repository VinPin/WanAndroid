...
import com.vinpin.wanandroid.main.wechat.WechatRespository
import kotlinx.coroutines.launch

/**
 * <pre>
 *     author: VinPin
 *     time  : 2019/12/13 9:27
 *     desc  : 微信公众号的文章的ViewModel
 * </pre>
 */
class WechatArticleViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun getArticleList(id: Int) {
        viewModelScope.launch {
            page = 1
            val apiResponse = mWechatRespository.getWxArticleList(id, page)
            // 列表数据
            mInfos.clear()
